...
echo "deb http://ftp.debian.org/debian bookworm-backports main" >> /etc/apt/sources.list.d/linaro-glt-gig-archive-bookworm.list
...
apt-get update
DEBIAN_FRONTEND=noninteractive apt-get install -y -q ca-certificates curl
