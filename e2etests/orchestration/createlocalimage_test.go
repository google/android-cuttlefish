...
func TestInstance(t *testing.T) {
	...
	if err := uploadCVDHostPackageTar(srv, uploadDir, "cvd-host_package.tar.gz"); err != nil {
		t.Fatal(err)
	}
	config := `
  {
...
func uploadCVDHostPackageTar(srv client.HostOrchestratorService, remoteDir, src string) error {
