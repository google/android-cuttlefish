...
void Egl::Init() {
  ...
  LOG(INFO) << "Found EGL client version " << client_version_major << "."
  ...
  LOG(INFO) << "Found EGL vendor: " << vendor_string;
  ...
  LOG(INFO) << "Found EGL extensions: " << extensions_string;
  ...
  LOG(INFO) << "Found matching framebuffer config.";
