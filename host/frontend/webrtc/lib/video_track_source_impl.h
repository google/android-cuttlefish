...
// Wraps a VideoTrackSourceImpl as an implementation of the VideoSinkInterface.
// This is needed as the VideoTrackSourceImpl is a reference counted object that
// should only be reference by rtc::scoped_refptr pointers, but the
// VideoSinkInterface is not a reference counted object and therefore not
...
class VideoTrackSourceImplSinkWrapper
 ...
 public:
  ...
  void OnFrame(const webrtc::VideoFrame& frame) override {
    track_source_impl_->OnFrame(frame);
  }
