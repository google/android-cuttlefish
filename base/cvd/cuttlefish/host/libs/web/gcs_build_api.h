...
// Handles build sources backed by Google Cloud Storage objects
// (gs://bucket/object). Always authenticated via the supplied
// CredentialSource. Translates GCS URLs to the GCS JSON API.
class GcsBuildApi {
 public:
 ...
 private:
  ...
  std::string BuildGcsApiUrl(const std::string& bucket,
