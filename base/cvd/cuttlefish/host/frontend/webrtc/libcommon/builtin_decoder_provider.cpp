...
// Decoder provider that wraps WebRTC's builtin decoder factory.
//
// Provides software codecs (VP8, VP9, AV1) as a fallback when hardware
// or stub decoders are not available. Priority 0 ensures this is used only
// when no higher-priority provider can handle the format.
